...
$sql[]="INSERT INTO `{$dbprefix}acces` (`nom`,`groupe_id`,`groupe`,`page`,`categorie`,`ordre`) VALUES ('Congés - Infos','7','Gestion des cong&eacute;s, validation N1','plugins/conges/infos.php','Cong&eacute;s','75');";
